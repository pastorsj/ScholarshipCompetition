...
# Contracts
write.csv(contracts.df %>% select(subaward_action_date, subaward_amount, subawardee_name, subaward_description), "./visualization_data/contract_info.csv", row.names = FALSE)
```
